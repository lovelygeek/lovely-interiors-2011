...
<?php if ( have_comments() ) : ?>
	...
	<div class="navigation">
		...
		<div class="previous"><?php next_comments_link() ?></div>
	</div>
 ...
 <?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ('open' == $post->comment_status) : ?>
	 ...
	 <?php else : // comments are closed ?>
		...
		<h4>Closed Comments</h4>
		
		For spam prevention, comments on this post are now closed. <br />
		You may <a href="<?php echo site_url(); ?>/contact/">contact me</a> for further discussion.
	<?php endif; ?>
